                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="card" style="width: 18rem;">
                                <img src="{{ $room->image }}" class="card-img-top" alt="..." style="height: 200px; width: 286px; object-fit: cover">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $room->title }}</h5>
                                    <p class="card-text">{{ substr($room->description,0,100) }}</p>
                                    <p class="card-text"><strong>Room type : </strong>{{ $room->room_type }}</p>
                                    <p class="card-text"><strong>Room price : </strong>${{ $room->price }}</p>
                                    <a href="{{ url('/view/details/'.$room->id) }}" class="btn btn-primary">Book Now</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="col-md-12">
                    <div class="row">
                        @foreach($data['foods'] as $food)
                            <div class="col-md-4 mt-3">
                                <div class="card" style="width: 18rem;">
                                    <img src="{{ $food->image }}" class="card-img-top" alt="..." style="height: 200px; width: 286px; object-fit: cover">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $food->name }}</h5>
                                        <p class="card-text">{{ substr($food->description,0,100) }}</p>
                                        <p class="card-text"><strong>Price : </strong>${{ $food->price }}</p>
                                        <a href="{{ url('/food/view/details/'.$food->id) }}" class="btn btn-primary">Buy Now</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
